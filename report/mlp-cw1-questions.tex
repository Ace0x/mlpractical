...
\begin{figure}[t]
    ...
    \begin{subfigure}{\linewidth}
        \includegraphics[width=\linewidth]{figures/accuracy_32_64_128.png}
        \caption{accuracy by epoch}
        \label{fig:width_acccurves}
    \end{subfigure} 
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/error_32_64_128.png}
...
\begin{figure}[t]
    \centering
    \begin{subfigure}{\linewidth}
        \includegraphics[width=\linewidth]{figures/depth_accuracy_128.png}
        \caption{accuracy by epoch}
        \label{fig:depth_acccurves}
    \end{subfigure} 
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/depth_error_128.png}
        \caption{error by epoch}
...
\begin{figure*}[t]
    ...
    \begin{subfigure}{.475\linewidth}
        \includegraphics[width=\linewidth]{figures/accuracy_gap_dropout.png}
        \caption{Accuracy and error by inclusion probability.}
        \label{fig:dropoutrates}
    \end{subfigure} 
    \begin{subfigure}{.475\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/accuracy_gap_l1_l2.png}
...
\begin{figure*}[t]
    \centering
    \begin{subfigure}{.475\linewidth}
        \includegraphics[width=\linewidth]{figures/accuracy_l1l2_gap.png}
    ...
    \begin{subfigure}{.475\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/error_l1l2_gap.png}
